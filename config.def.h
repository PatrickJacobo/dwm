...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_a,      spawn,     {.v =light_up} },
	{ MODKEY,                       XK_s,      spawn,     {.v = light_down} },
    ...
    /* View */
  /* this keybinds make it so you can see all windows in the same desktop, or keep a window in all desktops */
